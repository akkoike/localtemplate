...
- Azure log Analytics Workspace に Azure Monitor Private Link Scope が設定された後、Azure Log Analytics Workspace へのpublic endpointはデータインジェストの部分を無効に設定し、クエリアクセスは有効にします。
