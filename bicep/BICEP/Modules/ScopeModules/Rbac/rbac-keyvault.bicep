...
// User variables
var USER_OBJECT_ID = loadJsonContent('./ampls-user.json', 'UserObjectId001')
...
resource keyv 'Microsoft.KeyVault/vaults@2022-11-01' existing = {
  name: keyvaultName
}
...
resource roleAssignmentampls 'Microsoft.Authorization/roleAssignments@2020-04-01-preview' = {
  name: guid(keyv.id, USER_OBJECT_ID, contributorRoleDefinition.id)
  scope: keyv
  properties: {
